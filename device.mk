...
PRODUCT_COPY_FILES += \
    hardware/google/pixel/mm/fstab.zram.50p:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.zram
...
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/configs/thermal/thermal-map.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-map.conf \
